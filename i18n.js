...
window.SKY_TRANSLATIONS = {
    ja: {
        ...
        "refine.shardNotifyUnsupported": "⚠️ この端末のブラウザは通知に対応していません",
        "refine.shardNotifyDenied": "⚠️ 通知が許可されませんでした。ブラウザの設定から通知を許可してください",
        ...
        "candle.dailyBreakdownNegativeWarning": "⚠️ {date} 頃にキャンドルが不足する見込みです",
        ...
        "area.mapLegendToday": "曜日限定・本日該当",
        "area.viewList": "📋 リスト",
        "area.viewMap": "🗺️ ミニマップ",
        "area.viewAtlas": "🧭 精密マップ",
        "area.bgSetBtn": "この地図の背景画像を設定",
    ...
    en: {
        ...
        "refine.shardNotifyUnsupported": "⚠️ Notifications aren't supported on this browser",
        "refine.shardNotifyDenied": "⚠️ Notification permission was denied. Please allow notifications in your browser settings",
        ...
        "candle.dailyBreakdownNegativeWarning": "⚠️ You're projected to run short of candles around {date}",
        ...
        "area.mapLegendToday": "Weekday-limited · active today",
        "area.viewList": "📋 List",
        "area.viewMap": "🗺️ Mini-Map",
        "area.viewAtlas": "🧭 Precise Map",
        "area.bgSetBtn": "Set This Map's Background Image",
