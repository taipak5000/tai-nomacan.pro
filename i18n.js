...
window.SKY_TRANSLATIONS = {
    ja: {
        ...
        "candle.currentCandlesSyncNote": "🔗 itemのウィッシュリスト/プロフィール切替モーダルの所持キャンドルと連動（同じプロフィールなら自動で同期）",
        ...
        "route.createdFromSelectionHint": "この選択をルートとして作成しました！並び替え・計測はこの下から",
        ...
        "area.createRouteBtn": "この選択でルートを作る",
    ...
    en: {
        ...
        "candle.currentCandlesSyncNote": "🔗 Synced with item's Wishlist / Profile switcher's owned candles (auto-syncs within the same profile)",
        ...
        "route.createdFromSelectionHint": "Created a route from this selection! Reorder and time it below",
        ...
        "area.createRouteBtn": "Create a Route From This Selection",
...
window.SKY_AREA_NAMES_EN = {
    ...
    // ── 有名プレイヤー公開ルートのテンプレート（index.html内 FAMOUS_ROUTE_TEMPLATE）──
    // Wikiベースの既存エリアツリーとは別立てのカスタムエリアとして追加されるため、
    // ここに個別追加しないと英語表示時だけ日本語のまま残ってしまう。
    "20本ルート（ソロ・試練なし）": "20-Spot Route (Solo, No Trials)",
    "雨林（固定）": "Forest (Fixed)",
    "雨林→峡谷": "Forest → Valley",
    "他": "Other",
    "開拓地〜3門": "Clearing to Triple Door",
    "晴れ間": "Elevated Clearing",
    "※チャレスペ": "*Challenge Space",
    "パン焼き": "Bread Baking",
    "神殿前": "Near the Temple",
    "入ってすぐ": "Right After Entering",
    "蝶々の住処": "Butterfly Fields",
    "カメの大闇": "Turtle's Large Dark Crystal",
    "二枚貝": "Clam",
    "貝（小）×n": "Small Shells ×n",
    "1F ベンチ近く": "1F Near the Bench",
    "1F DC": "1F DC",
    "1F 台座の近く": "1F Near the Pedestal",
    "2F DC1": "2F DC1",
    "2F DC2": "2F DC2",
    "2F 4人扉前": "2F Before the 4-Player Door",
    "4F DC1": "4F DC1",
    "4F DC2": "4F DC2",
    "4F DC3": "4F DC3",
    "4F DC4": "4F DC4",
    ...
    "カフェ": "Cafe",
    "カーニバル": "Carnival",
    "風の街道 DC": "The Wind Paths DC",
    "風の街道 諸々": "The Wind Paths (Misc)",
    "隠者の峠 DC": "Hermit Valley DC",
    "レースキャンドル": "Race Candle",
    "夢見DC1": "Village of Dreams DC1",
    "夢見DC2": "Village of Dreams DC2",
    "音楽": "Harmony Hall",
    "DDC": "DDC",
    "スライダー": "Slide",
    "スケートリンク": "Ice Rink",
    "陸レ": "Sliding Race",
    "神殿内": "Inside the Temple",
};
